...
- **`add-disc`** — Stage 12, once per disc, right before that disc's own staging
  ...
  ```json
  {
    "volume_label": "SAMPLESHOW_S5D5",
    "drive_index": 1,
    "placed": [{"filename": "Sample Show - S05E16 - The Long Way Home.mkv"}],
    "bonus": [{"filename": "Sample Show Bonus Feature.mkv", "handling": "kept", "subtype": "featurette"}],
...
### SAMPLESHOW_S5D5 (drive 1)

| Category | Item | Detail |
|---|---|---|
| Placed | Sample Show - S05E16 - The Long Way Home.mkv | -- |
| Placed | Sample Show - S05E17 - Aftermath.mkv | -- |
| Excluded pre-rip | title 3 | concat/Play-All |

### SAMPLESHOW_S5D6 (drive 0)

| Category | Item | Detail |
|---|---|---|
| Placed | Sample Show - S05E18 - New Beginnings.mkv | -- |
| Bonus | Sample Show Bonus Feature.mkv [featurette] | kept |
